...
const file_proto_test_proto_rawDesc = "" +
	...
	"\x0fGreetingService\x120\n" +
	"\bSayHello\x12\x12.test.HelloRequest\x1a\x10.test.HelloReplyB\tZ\a./protob\x06proto3"
...
var file_proto_test_proto_depIdxs = []int32{
	0, // 0: test.GreetingService.SayHello:input_type -> test.HelloRequest
	1, // 1: test.GreetingService.SayHello:output_type -> test.HelloReply
